...
(gtk_accel_path "<Actions>/terminal-window/new-tab" "<Shift><Super>t")
...
(gtk_accel_path "<Actions>/terminal-window/zoom-in" "<Primary><Shift>Down")
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "<Alt><Super>f")
...
(gtk_accel_path "<Actions>/terminal-window/new-window" "<Super>t")
...
(gtk_accel_path "<Actions>/terminal-window/zoom-reset" "<Shift><Super>n")
; (gtk_accel_path "<Actions>/terminal-window/goto-tab-8" "<Alt>8")
(gtk_accel_path "<Actions>/terminal-window/detach-tab" "<Alt><Super>d")
...
(gtk_accel_path "<Actions>/terminal-window/select-all" "<Alt><Super>a")
...
(gtk_accel_path "<Actions>/terminal-window/preferences" "<Primary><Super>p")
